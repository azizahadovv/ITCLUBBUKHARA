        ...
        <div className='flex items-center justify-center'>
            <Rodal height={400} visible={modalVisible} onClose={() => setModalVisible(false)}>
                <form className='flex flex-col justify-center gap-2 py-4'>
                    <p className='text-center text-black text-[18px] leading-1'>{t("Register-information")}</p>
                    <div className="mb-3 form-floating">
                        ...
                        <label htmlFor="floatingNumber">{t("Register-name")}</label>
                    </div>
                    <div className="mb-3 form-floating">
                        ...
                        <label htmlFor="floatingNumber">{t("Register-number")}</label>
                    </div>
                    <div className="mb-3 form-floating">
                    ...
                    <div className='flex items-center justify-center gap-3 center'>
                        <button type='button' onClick={ExitModal} className='btn btn-danger w-50'>{t("Register-cancel")}</button>
                        <button type='button' onClick={AddUserModal} className='btn btn-success w-50'>{t("Register-add")}</button>
                    </div>
                </form>
            </Rodal>
        </div>
